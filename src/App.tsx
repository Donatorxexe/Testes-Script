...
// ═══════════════════════════════════════════════════════
// MEDUSA v14.4 PROFILE ARCHITECT — Premium Web Showcase
...
const TABS: TabData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: '🐍', name: 'Watermark Draggável', desc: 'HUD com MEDUSA v14.4 | ME: PT | SV: US | FPS | Ping — arrasta para qualquer posição', tag: 'HUD', tagColor: '#a855f7' },
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 20px' }}>
          <p style={{ fontSize: '12px', color: '#71717a', marginBottom: '4px' }}>
            🐍 MEDUSA v14.4 PROFILE ARCHITECT — Made by <span style={{ color: '#00d4aa', fontWeight: 700 }}>.donatorexe.</span>
          </p>
